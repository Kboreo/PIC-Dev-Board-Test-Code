...
*/
#define test_io_SetHigh()          _LATB9 = 1
/**
  @Summary
...
*/
#define test_io_SetLow()           _LATB9 = 0
/**
  @Summary
...
*/
#define test_io_Toggle()           _LATB9 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RB9
    postValue = test_io_GetValue();
    </code>

*/
#define test_io_GetValue()         _RB9
/**
  @Summary
  ...
  @Example
    ...
    test_io_SetDigitalInput();
    </code>

*/
#define test_io_SetDigitalInput()  _TRISB9 = 1
/**
  @Summary
  ...
  @Example
    ...
    test_io_SetDigitalOutput();
    </code>

*/
#define test_io_SetDigitalOutput() _TRISB9 = 0
/**
  @Summary
...
*/
#define IO_RED_SetHigh()          _LATC5 = 1
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RC5
    postValue = IO_RED_GetValue();
    </code>

*/
#define IO_RED_GetValue()         _RC5
/**
  @Summary
  ...
  @Example
    ...
    IO_RED_SetDigitalInput();
    </code>

*/
#define IO_RED_SetDigitalInput()  _TRISC5 = 1
/**
  @Summary
  ...
  @Example
    ...
    IO_RED_SetDigitalOutput();
    </code>

*/
#define IO_RED_SetDigitalOutput() _TRISC5 = 0
/**
  @Summary
...
*/
#define BUTTON_RC8_SetHigh()          _LATC8 = 1
/**
  @Summary
...
*/
#define BUTTON_RC8_SetLow()           _LATC8 = 0
/**
  @Summary
...
*/
#define BUTTON_RC8_Toggle()           _LATC8 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RC8
    postValue = BUTTON_RC8_GetValue();
    </code>

*/
#define BUTTON_RC8_GetValue()         _RC8
/**
  @Summary
  ...
  @Example
    ...
    BUTTON_RC8_SetDigitalInput();
    </code>

*/
#define BUTTON_RC8_SetDigitalInput()  _TRISC8 = 1
/**
  @Summary
  ...
  @Example
    ...
    BUTTON_RC8_SetDigitalOutput();
    </code>

*/
#define BUTTON_RC8_SetDigitalOutput() _TRISC8 = 0
/**
  @Summary
...
*/
#define BUTTON_RC9_SetHigh()          _LATC9 = 1
/**
  @Summary
...
*/
#define BUTTON_RC9_SetLow()           _LATC9 = 0
/**
  @Summary
...
*/
#define BUTTON_RC9_Toggle()           _LATC9 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RC9
    postValue = BUTTON_RC9_GetValue();
    </code>

*/
#define BUTTON_RC9_GetValue()         _RC9
/**
  @Summary
  ...
  @Example
    ...
    BUTTON_RC9_SetDigitalInput();
    </code>

*/
#define BUTTON_RC9_SetDigitalInput()  _TRISC9 = 1
/**
  @Summary
  ...
  @Example
    ...
    BUTTON_RC9_SetDigitalOutput();
    </code>

*/
#define BUTTON_RC9_SetDigitalOutput() _TRISC9 = 0
